...
- **600–1,200 Chinese characters** for the body (adjust if the source is very short or very long)
...
- **Questions**: 2–3 comprehension questions
...
- **一句话概括** at the end
- **2–3 comprehension questions** (cause-effect, comparison, or implication — not mere fact recall)
