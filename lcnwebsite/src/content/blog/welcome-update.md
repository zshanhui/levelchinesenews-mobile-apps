...
- downloading and lookup words using the local dictionary and Pleco integration
- using sentence level translations
- testing article fetch and parse workflow using zaobao.com news articles

If you are testing the app and want to share feedback, we would love to hear from you. You can email the development directly at shanhui+lcnfeedback@proton.me
