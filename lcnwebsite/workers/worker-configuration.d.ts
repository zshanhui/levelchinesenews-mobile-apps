/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/worker-configuration.d.ts --config workers/wrangler.toml` (hash: 2f0e7c9d0c6a0beeeef4ff459c17f5c1)
// Runtime types generated with workerd@1.20260409.1 2024-12-01 
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./contact");
    }
    interface Env {
        CONTACT_TO_EMAIL: "shanhui@proton.me";
        BUG_REPORT_EMAIL: "bugreport@levelchinese.app";
        MAIL_FROM: "LevelChinese News <contact@levelchinese.app>";
