...
function WebViewportShell({ children }: { children: React.ReactNode }) {
  ...
  // Full-bleed shell so article FlashList receives wheel events in the side gutters.
  // Content width is capped via padding on the article/settings scroll views.
  return (
